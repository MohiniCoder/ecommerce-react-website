                ...
                <div className='card shadow-md w-[500px] m-auto rounded-md bg-white p-5 px-10'>
                    ...
                    <form className='w-full mt-5'>
                         <div className='form-group w-full mb-5 relative'>
                            ...
                            <TextField type="name" id="email" label="Full Name " variant="outlined" className='w-full'/>
                        </div>
                        <div className='form-group w-full mb-5 relative'>
...
isShowPassword===false?  <IoMdEye className='text-[20px] opacity-75' />:  <IoMdEyeOff className='text-[20px] opacity-75' />
                         ...
                         <a className='link cursor-pointer text-[14px] font-[600] ' >
                          Forgot Password?
                            ...
                            <p className=' mb-8 text-center'>Allready have an account?<Link  className='lonk text-[14px] font-[600] pl-2 text-primary text-[#FF5252]' to="/login">Login</Link></p>
